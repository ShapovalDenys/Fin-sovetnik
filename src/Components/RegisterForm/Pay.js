...
const Pay = () => {
  ...
  <form className="pay" onSubmit={(e) => onSubmitPay(e)}>
    ...
    <p className="pay__disclaimer">
      В системе Uniteller безопасность платежей и конфиденциальность
      ...
      компании Uniteller по телефону 8 800 707-67-19 или
      электронной почте <a className="pay__disclaimer-link" href="mailto:support@uniteller.ru">support@uniteller.ru</a>
    </p>
